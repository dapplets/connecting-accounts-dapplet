...
export default (props: IDappStateProps<IStorage>) => {
    ...
    const addForm = () => {
        ...
        if (sharedState.global.madeRequest) {
            return (
                <Form title="Processing" buttonLabel="Log out" action={handleLogOut} loading={true}>
                    <p>
                        The Oracle needs some time to verifiy your account. Check the status in your
            ...
            return (
                ...
                >
                    <p>
                        ...
                        to <b>{sharedState.global.userNearId.length > 40 ? cutString(sharedState.global.userNearId) : sharedState.global.userNearId}</b>. You can disconnect these accounts
                        or log in with another NEAR wallet
                    </p>
                </Form>
            )
        }
        return (
            ...
            >
                <p>
                    ...
                    to <b>{sharedState.global.userNearId.length > 40 ? cutString(sharedState.global.userNearId) : sharedState.global.userNearId}</b>
                </p>
            </Form>
        )
    }

    return sharedState && !!sharedState.global && <div className="container">{addForm()}</div>
}
