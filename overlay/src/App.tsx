    ...
    const handleConnectAccounts = async (e: any) => {
        ...
        if (requestId >= 0) {
            ...
            if (result === 'approved' && sharedState.global) {
                bridge.updateUserConnectedAccounts(sharedState.global.userWebsiteId)
            }
        }
        setIsWaiting(false)
    }
        ...
        !!sharedState.global && (
            <div className="container">
                {sharedState.global.userWebsiteId === '' ? (
                    ...
                    >
                        <p>
                            The Oracle needs some time to verifiy your account. Check the status in
                            your list of connected accounts
                        </p>
                    </Form>
                ) : sharedState[sharedState.global.userWebsiteId]?.connectedAccounts
                      ?.map((x) => x.name)
                    ...
                    >
                        <p>
                            ...
                            to <b>{sharedState.global.userNearId}</b>. You can disconnect these
                            accounts or log in with another NEAR wallet
                        </p>
                    </Form>
                ) : (
                    <Form
                    ...
                    >
                        <p>
                            ...
                            to <b>{sharedState.global.userNearId}</b>
                        </p>
                    </Form>
                )}
            </div>
